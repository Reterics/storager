...
describe("StyledSelect", () => {
    ...
    it("sets the correct option as selected based on the value prop", () => {
        ...
        const optionElement = screen.getByRole("option", { name: "Option 2" }) as HTMLOptionElement;
        expect((optionElement.parentElement as HTMLSelectElement).value).toEqual('option2');
    });
});
