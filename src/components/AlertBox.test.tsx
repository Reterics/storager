...
describe('AlertBox', () => {
    ...
    it('should render AlertBox in all color combination', () => {
        const {container, getByText, rerender} = render(<AlertBox message={'Test'}/>);
        ...
        const types: ('alert'|'success'|'warning'|'dark'|'default'|'info')[] = ['alert', 'success', 'warning', 'dark']
        const classes = ['text-red-800', 'text-green-800', 'text-yellow-800', 'text-gray-800'];
