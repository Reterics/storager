...
const ConfirmModal: React.FC<ConfirmModalProps> = ({
    ...
    return (
        <GeneralModal title={title || t('Confirmation')} buttons={buttons} inPlace={inPlace} id="ConfirmModal">
            <div className="text-md p-2 dark:text-white text-gray-800">{children || t('Are you sure?')}</div>
        </GeneralModal>
    );
};
