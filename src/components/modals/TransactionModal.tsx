...
export default function TransactionModal({onClose, onSave, setTransaction, transaction, inPlace, shops}: TransactionModalProps) {
    ...
    return (<GeneralModal buttons={buttons} inPlace={inPlace}
                          title={t('Edit Transaction')} id={'TransactionModal'}>
        <FormRow>
            <StyledInput
                type="text" name="name"
            ...
            <StyledSelect
                ...
                onSelect={(e) => changeType(e as unknown as ChangeEvent<HTMLInputElement>, 'item_type')}
                label={t("Item type")}
            />
        ...
        <FormRow>
            ...
            <StyledSelect
                ...
                onSelect={(e) => changeType(e as unknown as ChangeEvent<HTMLInputElement>, 'document_type')}
