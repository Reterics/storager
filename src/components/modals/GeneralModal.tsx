      ...
      <div
        className={
          inPlace
            ...
            : 'bg-white p-3 sm:p-4 rounded dark:bg-gray-900 w-[95vw] sm:w-auto sm:min-w-[50vw] max-w-[95vw] sm:max-w-[80vw] md:max-w-screen-md md:w-[80vw]'
        }
      >
        {title && (
              ...
              className={
                button.primary
                  ? 'text-white bg-gray-800 hover:bg-gray-900 focus:outline-none ' +
                    'focus:ring-4 focus:ring-gray-300 font-medium rounded-md text-sm md:text-base px-3 py-1.5 md:px-4 md:py-2 ' +
                  ...
                  : 'text-gray-900 bg-white border border-gray-300 focus:outline-none ' +
                    ...
                    'text-sm md:text-base px-3 py-1.5 md:px-4 md:py-2 dark:bg-gray-800 dark:text-white dark:border-gray-600 ' +
