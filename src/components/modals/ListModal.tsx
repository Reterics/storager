...
export default function ListModal({lines, header, inPlace, title, buttons}: ListModalArguments) {
    const { t } = useTranslation();
    return (
        <GeneralModal buttons={buttons} inPlace={inPlace} title={title || t('List Modal')} id={"ListModal"}>
