...
export default function ServiceModal({
  ...
  return (
    <GeneralModal
      ...
      inPlace={inPlace}
      title={
        service.onUpdate ? t('Service Form') : t('Service Acceptance Form')
      }
      id={id || 'ServiceModal'}
    >
      ...
      <FormRow>
        <StyledSelect
          options={getTranslatedSelectOptions(serviceStatusList, t)}
          name="serviceStatus"
      ...
      {!service.onUpdate && (
        <pre
          className={settings?.serviceAgreement ? 'mt-2 mb-2 max-w-[80vw]' : ''}
        >
