  ...
  return (
      <section className="bg-gray-50 dark:bg-gray-900 min-h-screen flex items-center justify-center">
        <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto w-full max-w-md">
          <a href="?page=about" className="flex flex-col items-center mb-6 text-2xl font-semibold text-gray-900 dark:text-white">
          ...
          <div className="w-full bg-white rounded-lg shadow dark:border dark:bg-gray-800 dark:border-gray-700 p-6">
            ...
            {loading ? (
                ...
                <form className="space-y-4" onSubmit={e => { e.preventDefault(); SignIn({ email, password }); }}>
                  <div>
            ...
            <p className="text-sm font-light text-gray-500 dark:text-gray-400 mt-4">
              ...
              <a href="?page=terms" className="font-medium text-primary-600 hover:underline dark:text-primary-500 ml-1">
