...
import {Shop, TableLineElementType, TableLineType} from "../interfaces/interfaces.ts";
...
describe('RecycleBin Component', () => {
    ...
    it('handles items without shop_id gracefully', () => {
        ...
        render(
            <MemoryRouter>
                <DBContext.Provider value={dbContextWithItemWithoutShopId as unknown as DBContextType}>
                    <ShopContext.Provider value={mockShopContext}>
                        <RecycleBin />
                    </ShopContext.Provider>
                </DBContext.Provider>
